...
if st.session_state['best_tour'] !=None:
  ...
  columnConfig={
                ...
                "配送拠点":  st.column_config.Column(width=100),
                "必要物資量": st.column_config.Column(width=30),
                "走行距離": st.column_config.Column(width=30),
                "巡回順": st.column_config.Column(width=150) 
  }
